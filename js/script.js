	...
	jQuery(document).ready(function(){
		...
		$('.post-content-container').hover(
			function(){
				...
				$(this).children('.post-inner').children('.post-content').children('.post-date').css({'background-color':'#04c6b4'});
			...
			function(){
				...
				$(this).children('.post-inner').children('.post-content').children('.post-date').children('a').css({'color':'#04c6b4'});
			}
		)
